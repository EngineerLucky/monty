...
#include <ctype.h>
/**
 * struct stack_s - it should print doubly linked list representation of a stack (or queue)
 * @n: an integer
 * @prev: points to  previous element of the stack (or queue)
 * @next: points to next element of the stack (or queue)
 * Description: the doubly linked list node
 * structure for stack, queues, LIFO, FIFO Holberton project
 */
...
extern bus_t bus;
/**
 * struct instruction_s - am opcode and its function
 * @opcode:an opcode
